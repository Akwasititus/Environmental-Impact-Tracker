...
class ResultScreen extends StatelessWidget {
  ...
  final String emissionResult;

  static final routeName = "/result";

  ResultScreen(
      { required this.activityName, required this.userEmission, required this.averageEmission, required this.emissionResult});
