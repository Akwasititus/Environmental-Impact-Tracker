                                              ...
                                              MaterialPageRoute(
                                                  builder: (context) =>
                                                      ResultScreen(
                                                        ...
                                                        activityName: "Food", emissionResult: 'avoid plastic food packages and watch your diet',
                                                      )));
                                        } else {
                                          index++;
                                        }
                                                  ...
                                                  MaterialPageRoute(
                                                      builder: (context) =>
                                                          ResultScreen(
                                                            ...
                                                            activityName:
                                                                "Travel", emissionResult: ' avoid waste and use public transport or buy the buy the right car to avoid excessive emission of carbon',
                                                          )));
                                            } else {
                                              index++;
                                            }
                                              ...
                                              Navigator.pushReplacement(
                                                ...
                                                MaterialPageRoute(
                                                  builder: (context) =>
                                                    ...
                                                    activityName: "HouseHold", emissionResult: 'conserve energy and reduce household waste',
                                                  ),
                                                ),
                                              );
                                            } else {
